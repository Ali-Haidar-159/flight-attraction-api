...
// Save flight data in the database
let saveFlight = async function (req, res) {
    try {
        ...
        // Step 1: Fetch cities/airports from search destination API
        ...
        // Step 2: Ensure cities are in database
        ...
        // Step 4: Save flights to database
        const savedFlights = [];
        for (const offer of flightData.data.flightOffers.slice(0, 10)) {
            ...
            // Calculate fare (convert from units and nanos)
...
// Additional helper function to save cities from search destination API
