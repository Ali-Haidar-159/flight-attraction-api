...
let saveFlight = async function (req: Request, res: Response): Promise<Response> {
  try {
    ...
    const destinationData: SearchDestinationResponse = await fetchFromRapidAPI(searchUrl);
    ...
    const flightData: SearchFlightsResponse = await fetchFromRapidAPI(flightUrl);
...
let saveCities = async function (req: Request, res: Response): Promise<Response> {
  try {
